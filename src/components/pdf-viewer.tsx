  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[101] flex flex-col">
        {/* Header */}
        <div className="relative z-10 flex items-center justify-between px-6 py-4 bg-neutral-900/95 backdrop-blur-md border-b border-neutral-800">
        ...
        {/* Footer Hint */}
        <div className="relative z-10 px-6 py-2 bg-neutral-900/95 backdrop-blur-md border-t border-neutral-800">
