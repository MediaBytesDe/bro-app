...
const typeConfig: Record<string, { icon: any; color: string }> = {
  new_job: { icon: Briefcase, color: "text-green-400" },
  job_accepted: { icon: CheckCircle, color: "text-blue-400" },
  appointment: { icon: Calendar, color: "text-orange-400" },
  appointment_response: { icon: AlertCircle, color: "text-red-400" },
...
export default function PartnerBenachrichtigungenPage() {
